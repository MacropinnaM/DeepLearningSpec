...
from CA_Conv.random_mini_batches import random_mini_batches


def model(X_train, Y_train, X_test, Y_test, lr=0.009,
          num_epochs=100, mb_size=64, print_cost=True):
    """
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(num_epochs):
            minibatch_cost = 0.
            num_minibatches = int(m / mb_size)  # number of minibatches of size minibatch_size in the train set
            seed = seed + 1
